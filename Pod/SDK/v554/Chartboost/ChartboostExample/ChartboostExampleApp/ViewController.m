...
- (IBAction)showInPlay:(id)sender {
    ...
    // or may need to cache it and renderInPlay() will get called from the AppDelegate
}
...
- (void)renderInPlay:(CBInPlay*)inPlay {
    ...
    CGRect iconFrame = CGRectMake(screenWidth/2.0f - [appIconImage size].width/2.0f, 30.0f, [appIconImage size].height, [appIconImage size].width);
